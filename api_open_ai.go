...
func (a *OpenAIApiService) CancelFineTuneExecute(r ApiCancelFineTuneRequest) (*FineTune, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"fine_tune_id"+"}", url.PathEscape(parameterToString(r.fineTuneId, "")), -1)
...
func (a *OpenAIApiService) CreateImageEditExecute(r ApiCreateImageEditRequest) (*ImagesResponse, *http.Response, error) {
	...
	var maskLocalVarFile *os.File
	if r.mask != nil {
		maskLocalVarFile = *r.mask
	}
	if maskLocalVarFile != nil {
		fbs, _ := ioutil.ReadAll(maskLocalVarFile)
	...
	if r.n != nil {
		localVarFormParams.Add("n", parameterToString(*r.n, ""))
	}
	if r.size != nil {
		localVarFormParams.Add("size", parameterToString(*r.size, ""))
	}
	if r.responseFormat != nil {
		localVarFormParams.Add("response_format", parameterToString(*r.responseFormat, ""))
	}
	if r.user != nil {
...
func (a *OpenAIApiService) DeleteModelExecute(r ApiDeleteModelRequest) (*DeleteModelResponse, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"model"+"}", url.PathEscape(parameterToString(r.model, "")), -1)
